...
enum DeploymentPos
{
    ...
    //BIP147 DEPLOYMENT_BIP147, // Deployment of BIP147 (NULLDUMMY)
...
struct Params {
    ...
    int BIP66Height;
//****** DTG       /** Block height at which DIP0001 becomes active */
//****** DTG       int DIP0001Height;
    /**
    ...
    //int nPowKGWHeight; STASH Always use DGW
    //int nPowDGWHeight;
