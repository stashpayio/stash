...
#define BOOST_TEST_MODULE Stash Test Suite

#include "test_stash.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_stash_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
