...
// START STASH 
    SPORK_30_STASH_LEGACY_SIGS_ENABLED                     = 10030,
    SPORK_31_STASH_POS_ENABLED                             = 10031,
    SPORK_32_STASH_POS_START_BLOCK                         = 10032,
    SPORK_33_STASH_APPROX_RELEASE_HEIGHT                   = 10033,
    SPORK_34_STASH_WEEKS_UNTIL_DEPRECATION                 = 10034,
    SPORK_35_STASH_DEPRECATION_WARN_LIMIT                  = 10035,
    SPORK_36_STASH_CHAIN_PENALTY_ENABLED                   = 10036,
    SPORK_37_STASH_CHAIN_PENALTY_THRESHOLD                 = 10037,
// END STASH
...
public:
    ...
    inline void SerializationOp(Stream& s, Operation ser_action) {
        ...
        // not reuse pubkeys from previous stashd run
