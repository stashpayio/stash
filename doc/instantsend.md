...
This mechanism has been integrated into Bitcore-Node-Stash which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/stashpay/insight-api-stash#web-socket-api](https://github.com/stashpay/insight-api-stash#web-socket-api)
* API: [https://github.com/stashpay/insight-api-stash#instantsend-transactions](https://github.com/stashpay/insight-api-stash#instantsend-transactions)
...
By default, the Stash Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Stash Core daemon:
