...
official/supported Docker Images found at https://hub.docker.com/r/stashpay/stashd/
...
**NOTE: Please update the image description at https://hub.docker.com/r/stashpay/stashd-develop/ when changing the above text**