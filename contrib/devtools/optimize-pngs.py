...
pngcrush = 'pngcrush'
git = 'git'
folders = ["src/qt/res/movies", "src/qt/res/icons", "src/qt/res/icons/drkblue", "src/qt/res/icons/trad", "src/qt/res/images", "src/qt/res/images/drkblue", "src/qt/res/images/trad", "share/pixmaps"]
