# Linearize
Construct a linear, no-fork, best version of the Stash blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install stash_hash

https://github.com/stashpayio/stash_hash
...
JSON-RPC server. Running `stashd` or `stash-qt -server` will be sufficient.
...
* `input`: stashd blocks/ directory containing blkNNNNN.dat
