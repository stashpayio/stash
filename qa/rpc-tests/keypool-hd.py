...
class KeyPoolTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Restart node 0
        nodes[0] = start_node(0, self.options.tmpdir, ['-usehd=1', '-experimentalfeatures', '-developerencryptwallet'], redirect_stderr=True)
        # Keep creating keys
    ...
    def setup_network(self):
        self.nodes = start_nodes(1, self.options.tmpdir, [['-usehd=1', '-experimentalfeatures', '-developerencryptwallet']], redirect_stderr=True)
